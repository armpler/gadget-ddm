...
void every_timestep_stuff(void)
{
  ...
  if(ThisTask == 0)
	...
	{
	  z = 1.0 / (All.Time) - 1;
	  fprintf(FdInfo, "\nBegin Step %d, Time: %g, Redshift: %g, Systemstep: %g, Dloga: %g, OmegaDm: %g, OmegaBaryon: %g, OmegaR: %g, OmegaLambda: %g\n",
		  All.NumCurrentTiStep, All.Time, z, All.TimeStep,
		  log(All.Time) - log(All.Time - All.TimeStep),All.OmegaDm,All.OmegaBaryon,All.OmegaR,All.OmegaLambda);
	  printf("\nBegin Step %d, Time: %g, Redshift: %g, Systemstep: %g, Dloga: %g, OmegaDm: %g, OmegaBaryon: %g, OmegaR: %g, OmegaLambda: %g\n", All.NumCurrentTiStep,
		 All.Time, z, All.TimeStep, log(All.Time) - log(All.Time - All.TimeStep),All.OmegaDm,All.OmegaBaryon,All.OmegaR,All.OmegaLambda);
	  fflush(FdInfo);
	}
      else
	{
